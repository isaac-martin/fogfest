...
(function ($, root, undefined) {
  ...
  $(function () {
  		var classes = ['one', 'two', 'three','four','five', 'six', 'seven','eight','nine', 'ten', 'eleven'];
...
var fogfestbefore = new Date("1/19/2018");
var fogfestday = new Date("1/20/2018");

// var fogfestday = new Date("12/15/2017");


var todaysDate = new Date();

// call setHours to take the time out of the comparison
if(fogfestbefore.setHours(0,0,0,0) == todaysDate.setHours(0,0,0,0)) {
  $('body').addClass('before');
}

if(fogfestday.setHours(0,0,0,0) == todaysDate.setHours(0,0,0,0)) {
  $('body').addClass('of');
  var audio = document.getElementById("giants");
      audio.play();
